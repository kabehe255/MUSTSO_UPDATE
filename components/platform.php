...
<body>
    ...
    <section class="  mt-xxl-2">
        <div class="container px-5">

        <P class="display-4 mt-5 text-center pt-4">< Platform ></P>
        <p class="text-center text-bg-info rounded-4  text-danger font-italic">here is where you can pick up yoor respective ministry fot reporting your problem</p>
                    ...
                    <div class="col-md-6 col-lg-4 mt-5 wow fadeInUp" data-wow-delay=".2s"
                            ...
                            <div class="blog-grid">
                                <div class="blog-grid-img position-relative">
                                    <div class="   h-75"
                                        style="background:#000; border-bottom-left-radius: 25px;border-bottom-right-radius:25px">
                                    </div>
                                </div>
    ...
    <section id="about" class=" mt-xl-5">
